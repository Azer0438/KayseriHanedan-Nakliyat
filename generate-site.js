...
function homePage() {
  ...
  <section class="hero-quick-actions" aria-label="Hızlı iletişim">
    <div class="container">
      <a class="btn btn-primary" href="${waLink("Merhaba, Kayseri Hanedan Nakliyat web sitesinden teklif almak istiyorum.")}" target="_blank" rel="noopener">Hemen Teklif Al</a>
      <a class="btn btn-light phone-action" href="tel:${primaryTel}">${primaryPhone}</a>
      <a class="btn btn-light phone-action" href="tel:${secondaryTel}">${secondaryPhone}</a>
    </div>
  </section>
...
.hero-carousel { width: 100%; min-height: 540px; height: clamp(540px, 34vw, 640px); max-height: 640px; }
...
.hero-slide.bare-slide img { object-fit: cover; object-position: top center; }
...
.hero-quick-actions { background: #fff; padding: 18px 0; box-shadow: 0 10px 30px rgba(5, 21, 24, .08); }
.hero-quick-actions .container { display: flex; flex-wrap: wrap; gap: 14px; align-items: center; }
.hero-quick-actions .btn { min-width: 220px; min-height: 54px; }
.hero-quick-actions .phone-action { color: var(--ink); border: 1px solid rgba(181,18,32,.28); background: #fff; box-shadow: 0 8px 22px rgba(5, 21, 24, .06); }
.hero-quick-actions .phone-action:hover { color: var(--red); border-color: var(--red); transform: translateY(-2px); }
...
@media (max-width: 820px) {
  ...
  .hero-carousel { min-height: 560px; height: 560px; aspect-ratio: auto; max-height: none; }
  .hero-slide { align-items: start; }
  .hero-slide.bare-slide img { object-position: top left; }
...
@media (max-width: 540px) {
  ...
  .hero-carousel { min-height: 500px; height: 500px; aspect-ratio: auto; }
  .hero-slide.bare-slide img { object-position: top left; }
  .hero-quick-actions { padding: 12px 0; }
  .hero-quick-actions .container { display: grid; grid-template-columns: 1fr 1fr; gap: 8px; }
  .hero-quick-actions .btn { min-width: 0; min-height: 44px; padding: 0 12px; font-size: 12px; }
