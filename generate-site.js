...
<head>
  ...
  <meta property="og:image" content="${siteUrl}/assets/images/web-site-logo.webp?v=4">
  <meta property="og:image:secure_url" content="${siteUrl}/assets/images/web-site-logo.webp?v=4">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="${escapeHtml(title)}">
  <meta name="twitter:description" content="${escapeHtml(description)}">
  <meta name="twitter:image" content="${siteUrl}/assets/images/web-site-logo.webp?v=4">
